#!/bin/bash
# This script sets up ROS2 Humble and ARGoS3 by cloning the python_env repository
# and using its setup scripts
# Usage: bash setup_u22_argos.sh
...
echo "============================================================"
echo ""
echo "ROS2 Humble and ARGoS3 have been installed in your workspace."
echo ""
